...
minlat = SITE_latitude - (zoomerfctr-0)
maxlat = SITE_latitude + (zoomerfctr-0)
...
csv_turbines='/home/pmccrone/data/GIS/datacsv/uswtdb_v5_0_20220427TTT2019.csv'
...
plt.scatter(lon, lat, s=200, transform=ccrs.PlateCarree(),marker='^', \
    label=None, c=tyear, cmap='winter', linewidth=0.4, alpha=1.0, edgecolors='black')
