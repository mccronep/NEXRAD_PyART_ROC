...
#----------------------------------------------------------------
#
infromlinux = subprocess.getoutput('echo ${RADAR_BASEPATH}')
...
def PyART_NEXRAD_DopVel(sourcedatapath, datapath, my_XFER_BASEPATH, RADAR_Callsign, my_RADAR_BASEPATH):
    ...
    #
    #
    contents_sourcepath.sort() # added 2021-07-23
    ...
    #
    print(dadash+dadash)
    print("Selected datafile: "+result)
    print(dadash+dadash)
    #
    #list_of_1_files[0] = result
    #
    #cmd_str='/usr/bin/rm -rf '+tmpfile
    #OS.system(cmd_str)
    ...
    for item in list_of_1:
        ...
        if (read_radar_ok  == 1):
            ...
            #
            display.plot_label(my_text1, (-400000,-400000) , symbol='r+', text_color='red', ax=None)
            display.plot_label(my_text2, (400000,-400000) , symbol='r+', text_color='blue', ax=None)
...
def PyART_NEXRAD_File(sourcedatapath, datapath, my_XFER_BASEPATH, RADAR_Callsign, my_RADAR_BASEPATH):
    #
    print("Begin --Process_NEXRAD_File--")
    #n
    error_code=1
    #
    print('The value of --sourcedatapath-- is: '+str(sourcedatapath))
...
def main():
    ...
    #
    infromlinux = subprocess.getoutput('echo ${OPSBIN}')		### /satdat/bin
    #                                                           ### /u/ops/bin
    #
    ...
    #----------------------------------------------------------------
    #
    infromlinux = subprocess.getoutput('echo ${XFER_BASEPATH}')   ### XFER_BASEPATH=/satdat/curr/radar_nexrad_process
    #
...
#
#
program_name="Py_nexrad_refvel_process3.py"
